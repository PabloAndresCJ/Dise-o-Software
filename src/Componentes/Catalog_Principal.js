...
function Catalog_Principal() {
    return (<Container>
            ...
            <Row>
                <Col lg={6}>
                    <Card>
                        <Image src={require('./imgs/Catalog_Principal/Marshall-HP-Ajuste.jpg')} className='card-img-top' fluid></Image>
                        <h1>Headphones</h1>
                        <Card.Body>

                            <a href="/Headphones"><Button variant="outline-dark">Ver productos<svg xmlns="http://www.w3.org/2000/svg" width="16"
                ...
                <Col lg={6}>
                    <Card>
                        <Image src={require('./imgs/Catalog_Principal/deporte-Ajuste.jpg')} className='card-img-top' fluid></Image>
                        <h1>Deportivos</h1>
                        <Card.Body>
                            <a href="/Deportes"><Button variant="outline-dark">Ver productos <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                                                         height="16" fill="currentColor"
                ...
                <Col lg={6}>
                    ...
                    <Card>
                        <Image src={require('./imgs/Catalog_Principal/Bose-EP-II-Ajuste.jpg')} className='card-img-top' fluid>
                        </Image>
                        <h1>In-Ear</h1>
                        <Card.Body>
                            <a href="/InEar"><Button variant="outline-dark">Ver productos <svg
                ...
                <Col lg={6}>
                    <Card>
                        <Image src={require('./imgs/Catalog_Principal/Marshall-SP.jpg')} className='card-img-top' fluid></Image>
                        <h1>Speakers</h1>
                        <Card.Body>
                            <a href="/Parlantes"><Button variant="outline-dark">Ver productos <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                                                           height="16" fill="currentColor"
